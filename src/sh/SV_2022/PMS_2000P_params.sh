#!/bin/bash
#SBATCH --job-name=PMS-params-2000P-randinit
#SBATCH --qos=qos_gpu-t4
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=12
#SBATCH --output=slurm_out/PMS-params-2000p-randinit-%j.out
#SBATCH --error=slurm_out/PMS-params-2000p-randinit-%j.err
