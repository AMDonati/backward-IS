...
def run(args):
    ...
    write_to_csv(output_dir=os.path.join(args.data_path, "results_{}runs_{}J_{}particles.csv".format(args.runs, args.backward_samples, args.num_particles)), dic=dict_results)
